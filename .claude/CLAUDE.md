# claude-skills — project-level Claude instructions

This file is the project-level version of the root CLAUDE.md, loaded automatically when Claude Code opens in this directory. Content is identical to the root CLAUDE.md; this copy ensures Claude Code picks it up regardless of which directory is active.
